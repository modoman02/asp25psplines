...
- **Smoothing / model selection**: `AIC`, `BIC`, `ML`/`REML` (if implemented), `GCV` (configurable).
...
- **Coverage**: compare nominal vs. empirical (raw) coverage; optionally apply calibration procedures (calibrated coverage).
